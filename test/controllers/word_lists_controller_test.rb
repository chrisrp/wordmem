...
class WordListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create word_list" do
    assert_difference('WordList.count') do
      post word_lists_url, params: { word_list: { description: @word_list.description, name: @word_list.name } }
    end
  ...
  test "should update word_list" do
    patch word_list_url(@word_list), params: { word_list: { description: @word_list.description, name: @word_list.name } }
